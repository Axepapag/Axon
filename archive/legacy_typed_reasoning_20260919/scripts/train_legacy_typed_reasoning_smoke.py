...
def main() -> int:
    ...
    if not args.evaluate_only:
        raise RuntimeError(
            "the typed DELTA/NO_OP/ABSTAIN motor trainer is retired and cannot execute optimizer steps; "
            "use scripts/train_living_reasoning_smoke.py for English-native training or pass --evaluate-only "
            "to inspect immutable historical evidence"
        )
