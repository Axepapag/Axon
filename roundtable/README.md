...
- `reports/GROK_D64_MIXER_COPY_ALIGNMENT_SMOKE_2026-09-06.md` — both mixer
  smokes completed. Heldout copy-gate and position 1.0; stage gate failed
  on regression position 0.667. Next shot: FFN256 copy-alignment renewal.
  No serving. No width bump.
