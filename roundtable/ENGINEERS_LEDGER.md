...
Updated: 2026-08-23T18:25:53-05:00
Current through event: `evt-20260823T232553000000Z-chatgpt-trainer-learning-policy`
...
- Root `SOURCE_OF_TRUTH.md` is an exact mirror. Current verified SHA256: `40FC1BA4C09CACEBB4870575D88EEF3D5C216E9CD85DC87D409EA40FF5C23FA1` (Trainer governed learning-policy + exact mid-accumulation resume doctrine).
...
4. **Primary focus remains the Trainer organ before new core training.** Candidate isolation, single-writer authority, immutable governed learning policies, AdamW/SGD execution, deterministic scheduling, gradient accumulation, clipping/gradient/update budgets, FP32/BF16/FP16 precision, exact mid-accumulation checkpoint/resume, telemetry, deterministic promotion gates, atomic live-generation activation/rollback, restart hydration and read-only inspection are established. **Next: make LoRA/adapters first-class constructed/attached/composed/retired parameter generations with exact base-generation ancestry and activation/rollback semantics, then build provenance-preserving study/curriculum ingestion.** No semantic/reasoning training campaign starts until those controls can govern it.
